<template>
  <div  class="mt-6">
    ...
    <div v-else class="grid grid-cols-1 place-items-center border border-white border-1">
      <div v-for="(q,index) in allQuestions" :key="index" class="mb-4 grid justify-self-center">
