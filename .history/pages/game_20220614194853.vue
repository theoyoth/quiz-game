<template>
  <div  class="mt-6">
    ...
    <div v-else class="w-full border border-white border-1 grid grid-cols-1 place-items-center">
      <div v-for="(q,index) in allQuestions" :key="index" class="mb-4 border border-white border-1 w-2/5">
