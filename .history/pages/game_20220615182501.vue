...
export default {
  ...
  methods: {
    ...
    sendAnswer(e){
      ...
      // if(this.selectedAnswer.innerText == answer){
      //   this.selectedAnswer.parentElement.classList.add('correct')
      // }
      // else{
      //   this.selectedAnswer.parentElement.classList.add('incorrect')
      // }

      const classApply = this.selectedAnswer.innerText == answer ? 'correct' : 'incorrect'
      this.selectedAnswer.parentElement.classList.add(classApply)

      setTimeout(() => {
        this.selectedAnswer.parentElement.classList.remove(classApply)
