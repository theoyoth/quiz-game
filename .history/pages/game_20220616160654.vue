<template>
  <div  class="mt-6">
    ...
    <div v-if="feedback !== ''">
        <h1 class="text-center">{{feedback}}<span>{{score}}</span></h1>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async getNewQuestion(){
      if(this.allQuestions.length === 0){
        return this.feedback = "you are finished the questions, you got "
      }
      this.questionCounter++
      this.questionCounterText = this.questionCounter/maxQuestions
