<template>
  <div class="grid place-items-center">
    <div class="xl:w-1/2 lg:w-3/4 sm:w-11/12 md:w-2/3 bg-gray-600 rounded-lg mt-8 py-8">
      ...
      <div class="grid grid-cols-2 gap-4 justify-items-center relative">
        ...
        <font-awesome-icon :icon="['fas','crown']" class="absolute text-yellow-400 rotate-45 bottom-0 left-20"/>
